...
describe User do
  ...
  it 'check valid username and email' do
    # this can be done by be_valid also which wil check all rules defined in model file.
  ...
  it 'check email to be valid with factory' do
    # checking email can't be blank
  ...
  it 'check username is not duplicate' do
    # checking for multiple users and checking uniqueness
  ...
  it 'check user authentication' do
    User.create(username: 'akki209', email: 'akki209@example.com', encrypted_password: 'asas')
